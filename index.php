  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-2">April Apparel</div>
      </a>
	   ...
	   <li class="nav-item active">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=gudang">Data Item</a>
            <a class="collapse-item" href="?page=jenisbarang">Type Item</a>
            <a class="collapse-item" href="?page=satuanbarang">Unit Item</a>
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=barangmasuk">Incoming Item</a>
            <a class="collapse-item" href="?page=barangkeluar">Outgoing Item</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_supplier">Report Supplier</a>
            <a class="collapse-item" href="?page=laporan_gudang">Report Warehouse Stock</a>
			 <a class="collapse-item" href="?page=laporan_barangmasuk">Report Incoming Items</a>
            <a class="collapse-item" href="?page=laporan_barangkeluar">Report Outgoing Items</a>
          </div>
        </div>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Sofware Design by FISE MSU-Management Science and University &reg; 2023 . Sistem Informasi Inventaris Barang</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
